...
public class FuzzyLogic {
    ...
    public FuzzyLogic(double[] outsideTemp, double startT, double area, double height, double optT, double powerMax, int breakTime) {
    ...
    private final double startT, area, height, optT, powerMax;
    @Getter
